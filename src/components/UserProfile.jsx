  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        // Return cleanup function for Supabase auth listener
        return () => {
          // Supabase auth state change listeners are automatically cleaned up
          // No explicit unsubscribe needed for supabase.auth.onAuthStateChange
        };
